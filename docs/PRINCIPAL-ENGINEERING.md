...
## Core boundary
**Primary concern:** Model registry.

Treat metadata, validation, lifecycle state, provenance, and promotion as explicit boundaries; enforce valid transitions; keep storage adapters replaceable; test invalid state changes and promotion failures.
