...
|---|---|---|
| Architecture | [ARCHITECTURE.md](../ARCHITECTURE.md) | Model metadata, lifecycle, provenance and promotion boundaries and system boundaries |
| ADR | [0002-production-hardening.md](../ADRs/0002-production-hardening.md) | Explicit design trade-offs and production boundaries |
| Contracts | [tests/test_registry.py](../tests/test_registry.py) | Contract-focused validation at the repository boundary |
